                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Wacht tot je foto wordt goedgekeurd, als je foto wordt afgekeurd, probeer het opnieuw
                                met een nieuwe foto!
                            </div>
                        </div>
                    </div>
                ...
                for ($row = 0; $row < 4; $row++): ?>
                    <div class="row mt-2">
                        <?php for ($col = 0; $col < 4; $col++):
                            ...
                            ?>
                            <div class="col-3">
                                <div class="text-center p-4 square <?= $statusClass ?>" onclick="toggleSquare(this)"
                                    data-task-id="<?= $task['id'] ?>">
                                    <div>
                                        <div class="task-number" <?= $taskIndex == 9 ? 'style="font-size: 1em;"' : '' //Edge case because the 10 is too large in this font ?>>Taak <?= $taskIndex + 1 ?></div>
                                        <div class="task">
                                        ...
                                        <div class="submission-area">
                                            ...
                                            <?php else: ?>
                                                <input type="file" class="form-control mt-2 photo-input" accept="image/*"
                                                    style="display: none;">
